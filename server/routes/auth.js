    ...
    try {
      ...
      if (!isOutboundMailConfigured()) {
        return res.status(503).json({
          error:
            "\u041E\u0442\u043F\u0440\u0430\u0432\u043A\u0430 \u043F\u0438\u0441\u044C\u043C \u043D\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043D\u0430 \u043D\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0435. \u0423\u043A\u0430\u0436\u0438\u0442\u0435 SENDGRID_API_KEY \u0438 SENDGRID_FROM_EMAIL, \u0438\u043B\u0438 RESEND_API_KEY \u0438 RESEND_FROM, \u0438\u043B\u0438 \u043F\u043E\u043B\u043D\u044B\u0439 \u043D\u0430\u0431\u043E\u0440 SMTP_*.",
      ...
      if (!sent) {
        return res.status(503).json({
          error:
            "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u043F\u0438\u0441\u044C\u043C\u043E. \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u043B\u043E\u0433\u0438 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u0438 \u043F\u0435\u0440\u0435\u043C\u0435\u043D\u043D\u044B\u0435 \u043E\u043A\u0440\u0443\u0436\u0435\u043D\u0438\u044F (SendGrid / Brevo / Resend / SMTP).",
      ...
      if (err instanceof MailProviderError) {
        return res.status(err.httpStatus).json({ error: err.message, code: err.clientCode });
      }
  ...
  async function handleRecover(req, res) {
    try {
      ...
      if (!isOutboundMailConfigured()) {
        return res.status(503).json({
          error:
            "\u041E\u0442\u043F\u0440\u0430\u0432\u043A\u0430 \u043F\u0438\u0441\u044C\u043C \u043D\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043D\u0430. \u0423\u043A\u0430\u0436\u0438\u0442\u0435 SENDGRID_* \u0438\u043B\u0438 RESEND_API_KEY \u0438 RESEND_FROM \u0438\u043B\u0438 SMTP_* \u043D\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0435.",
      ...
      if (!sent) {
        return res.status(503).json({
          error:
            "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u043F\u0438\u0441\u044C\u043C\u043E. \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u043B\u043E\u0433\u0438 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u0438 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 SendGrid / Brevo / Resend / SMTP.",
